 ...
 */
package servlet;
import ajax.service.UpdateProductService;
...
public class UpdateProductServlet extends HttpServlet {
    ...
    private UpdateProductService service = null; 
    @Override
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String msg = service.updateProduct(productName, price, quantity, productId);
